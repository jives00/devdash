...
export default function LogPage({ params }: { params: { container: string } }) {
    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col">
      <div className="flex-1 flex flex-col max-w-full px-6 py-6 gap-4">
        <div className="flex items-center gap-4">
          <Link href="/" className="text-gray-300 hover:text-white text-sm">← Back</Link>
          <h1 className="text-white font-bold text-lg font-mono">{container}</h1>
          <span className="text-gray-400 text-sm">live log viewer</span>
        </div>
